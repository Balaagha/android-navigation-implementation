...
data class Letter(@PrimaryKey val uid: Long = Date().time) : Parcelable {
    ...
    constructor(parcel: Parcel) : this(parcel.readLong()) {
        ...
        savedAt = parcel.readValue(kotlin.Long::class.java.classLoader) as? Long
        sentAt = parcel.readValue(kotlin.Long::class.java.classLoader) as? Long
        receivedAt = parcel.readValue(kotlin.Long::class.java.classLoader) as? Long
    }
